    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder aviso = new AlertDialog.Builder(FullscreenActivity8.this);
                aviso.setMessage("A continuación debes elgerir tus actividades del día")
                        ...
                        .setPositiveButton("Entendido", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                //finish();
                                Intent s = new Intent(FullscreenActivity8.this, FullscreenActivity3.class);
                                startActivity(s);
                        ...
                        .setNegativeButton("Regresar al Menu", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Intent s = new Intent(FullscreenActivity8.this, FullscreenActivity.class);
                                startActivity(s);
                                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                            }
                        });
