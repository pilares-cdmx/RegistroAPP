...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEstudiante = (Button) findViewById(R.id.btnEstudianteLayout);
        //.setOnTouchListener(avisoPrivacidad);
        btnEstudiante.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent s = new Intent(FullscreenActivity.this, FullscreenActivity2.class);
                startActivity(s);
        ...
        btnInauguracion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent s = new Intent(FullscreenActivity.this, FullscreenActivity8.class);
                startActivity(s);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
