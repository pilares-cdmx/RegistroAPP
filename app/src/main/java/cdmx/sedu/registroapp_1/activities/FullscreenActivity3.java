package cdmx.sedu.registroapp_1.activities;
...
public class FullscreenActivity3 extends AppCompatActivity {
    ...
    private Button btnCiber;
    private Button btnFomento;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCiber = (Button) findViewById(R.id.btnCiber);
        //.setOnTouchListener(avisoPrivacidad);
        btnCiber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent s = new Intent(FullscreenActivity3.this, FullscreenActivity7.class);
                startActivity(s);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });

        btnFomento = (Button) findViewById(R.id.btnFomento);
        //.setOnTouchListener(avisoPrivacidad);
        btnFomento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent s = new Intent(FullscreenActivity3.this, FullscreenActivity5.class);
                startActivity(s);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        ...
        btnDeporte.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent s = new Intent(FullscreenActivity3.this, FullscreenActivity4.class);
                startActivity(s);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        ...
        btnCultura.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent s = new Intent(FullscreenActivity3.this, FullscreenActivity6.class);
                startActivity(s);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        ...
        //Eliminando la barra  de  navegación solohastaque  se da un touch
